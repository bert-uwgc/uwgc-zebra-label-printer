...
Synthetic [one-line](badge-preview-short.png) and [two-line](badge-preview-long.png) previews show the intended arrangement. They are geometry previews rendered at an assumed 203 dpi, not Conga output or files to send to the printer.
...
4. Confirm printer resolution and print method on its configuration report or in Zebra management tools. Non-direct-thermal stock requires a thermal-transfer capable printer and compatible ribbon.
...
- Confirmed DPI, print method, and ribbon-media pairing.
